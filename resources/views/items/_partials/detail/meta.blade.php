{{-- Item Meta Information Partial --}}
{{-- Usage: @include('items._partials.detail.meta', ['viewModel' => $viewModel]) --}}
...
<div class="khezana-item-meta">
    ...
    <span class="khezana-meta-value">{{ $viewModel->availabilityLabel }}</span>
</div>
